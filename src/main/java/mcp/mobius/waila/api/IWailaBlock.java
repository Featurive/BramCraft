...
public interface IWailaBlock {
	 ...
	 * ConfigHandler provides the current Waila config state so you can show/hide elements depending on the config. Refer the ConfigHandler class for more info.
