...
import com.featurive.bramcraft.model.ModelCondenser;
...
public class RenderCondenser extends TileEntitySpecialRenderer {
    ResourceLocation texture = new ResourceLocation(References.MOD_ID.toLowerCase() + ":" + "textures/models/condenser.png");

    private ModelCondenser model;

    public RenderCondenser(){
        this.model = new ModelCondenser();
    }
