...
public enum Color {
        ...
        private Color(char p_i1336_3_)
        {
            this(p_i1336_3_, false);
        }

        private Color(char p_i1337_3_, boolean p_i1337_4_)
        {
        ...
        public static Collection getValidValues(boolean p_96296_0_, boolean p_96296_1_)
        {
            ...
            for (int j = 0; j < i; ++j)
            {
                ...
                {
                    arraylist.add(color.getFriendlyName());
                }
            }
        ...
        static
        {
            ...
            for (int var2 = 0; var2 < var1; ++var2)
            {
                ...
                formattingCodeMapping.put(var3.getFormattingCode(), var3);
