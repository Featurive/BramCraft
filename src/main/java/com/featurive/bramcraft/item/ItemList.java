...
public class ItemList extends ModItem {
    ...
    //public static ModItem cheese =             (ModItem)    new ModItem().setUnlocalizedName(Names.Item.cheese);
    //public static ModItem chocolatebar =       (ModItem)    new ModItem().setUnlocalizedName(Names.Item.chocolatebar);
    ...
    //public static ModItem damage =             (ModItem)    new ModItem().setUnlocalizedName(Names.Item.damage);
    ...
    //public static ModItem key =                (ModItem)    new ModItem().setUnlocalizedName(Names.Item.key);
    public static ModItem mobile_enderchest =  (ModItem)    new ModItem().setUnlocalizedName(Names.Item.mobile_enderchest);
    //public static ModItem mobilifier =         (ModItem)    new ModItem().setUnlocalizedName(Names.Item.mobilifier);
    ...
    //public static ModItem shaker =             (ModItem)    new ModItem().setUnlocalizedName(Names.Item.shaker);
    ...
    //public static ModItem transmutation =      (ModItem)    new ModItem().setUnlocalizedName(Names.Item.transmutation);
}
