...
public class ModItems
{
    public static void registerItems()
    {
        ...
        //ModRegistry.register(ItemList.cheese, Names.Item.cheese, 0);
        //ModRegistry.register(ItemList.chocolatebar, Names.Item.chocolatebar, 0);
        ...
        //ModRegistry.register(ItemList.damage, Names.Item.damage, 0);
        ...
        //ModRegistry.register(ItemList.key, Names.Item.key, 0);
        ModRegistry.register(ItemList.mobile_enderchest, Names.Item.mobile_enderchest, 0);
        //ModRegistry.register(ItemList.mobilifier, Names.Item.mobilifier, 0);
        ...
        //ModRegistry.register(ItemList.shaker, Names.Item.shaker, 0);
        ...
        //ModRegistry.register(ItemList.transmutation, Names.Item.transmutation, 0);
    }
}
